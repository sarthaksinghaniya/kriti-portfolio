    ...
    <AnimatePresence>
      {isLoading && (
        <motion.div
          ...
          className="fixed inset-0 w-full h-screen bg-[#2a5aff] z-[100000] flex items-center justify-center"
        >
          {/* Logo Container */}
          <motion.div 
          ...
          >
            ...
            <div className="text-blue-900/30">
              Kriti<span className="text-blue-900/30">.</span>
            </div>
            ...
            >
              Kriti<span className="text-black">.</span>
            </motion.div>
          </motion.div>
